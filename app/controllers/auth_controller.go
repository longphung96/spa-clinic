...
import (
	...
	"github.com/longphung96/spa-clinic/app/models"
	"github.com/longphung96/spa-clinic/pkg/utils"
	"github.com/longphung96/spa-clinic/platform/cache"
	"github.com/longphung96/spa-clinic/platform/database"
...
func UserSignUp(c *fiber.Ctx) error {
	...
	roles, err := utils.VerifyRole(signUp.UserRole)
	if err != nil {
		// Return status 400 and error message.
		return c.Status(fiber.StatusBadRequest).JSON(fiber.Map{
			"error": true,
