...
import (
	...
	"github.com/longphung96/spa-clinic/configs"
	"github.com/longphung96/spa-clinic/models"
...
func DatabaseInit() *gorm.DB {
	...
	dsn := fmt.Sprintf("%s:%s@tcp(%s:%d)/%s?charset=utf8mb4&parseTime=True&loc=Local", configs.CommonConfig.DB_USER, configs.CommonConfig.DB_PASS, configs.CommonConfig.DB_HOST, configs.CommonConfig.DB_PORT, configs.CommonConfig.DB_NAME)
